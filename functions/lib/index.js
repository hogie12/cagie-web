...
exports.onDashboardUpdate = void 0;
const firestore_1 = require("firebase-functions/v2/firestore");
const admin = require("firebase-admin");
admin.initializeApp();
exports.onDashboardUpdate = (0, firestore_1.onDocumentWritten)({ document: "couples/{coupleId}/dashboard/main", region: "asia-southeast2" }, async (event) => {
    ...
    if (newData.greeting !== (prevData === null || prevData === void 0 ? void 0 : prevData.greeting) && newData.greetingBy) {
        title = "New Greeting! 💕";
        body = `Your partner left a greeting: "${newData.greeting}"`;
        senderId = newData.greetingBy;
    }
    // Check if daily PAP changed
    else if (newData.papUrl !== (prevData === null || prevData === void 0 ? void 0 : prevData.papUrl) && newData.papBy) {
        title = "New Daily PAP! 📸";
